...
and other resources found withing the `./kb8resources/myapp_frontend` directory. The secret resource will include a data
name for each file base name and a value with the base64 encoded file contents.
