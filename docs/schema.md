...
Most variables and settings will work in Defaults.yaml, environment files, deployment files or included files.

## Settings

### Contents

1. [ContainerVersionGlobPath](#containerversionglobpath)
2. [EnvFileGlobPath](#envfileglobpath)
3. [DefaultEnvName]
4. [Kb8Server]
5. [MultiTemplate]
6. [NoAutomaticUpgrade]
7. [NoControllerOk](#NoControllerOk)
8. [NoRollingUpdate](#NoRollingUpdate)
9. 
